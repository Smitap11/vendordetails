...
<div class="carousel-item active">
  ...
  <div class="row mb-3">
    <div class="col-md-6">
      ...
      <input type="email" class="form-control" name="contact-email" value="<?= old('contact-email') ?>">
      <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
    </div>

    <div class="col-md-6">
      <label for="additional_email" class="form-label">Additional Email</label>
      <input type="email" class="form-control" name="additional-email" value="<?= old('additional-email') ?>">
    </div>
  </div>
  ...
  <div class="row mb-3">
    <div class="col-md-6">
      ...
      <input type="number" class="form-control" name="contact-number" value="<?= old('contact-number') ?>">
    </div>

    <div class="col-md-6">
      <label for="alt_contact_number" class="form-label">Alternate Number</label>
      <input type="number" class="form-control" name="alt-contact-number" value="<?= old('alt-contact-number') ?>">
    </div>
  </div>
...
<script type="text/javascript">
    ...
    var csrfHash = '<?= csrf_hash() ?>'; 
        ...
        var saveFormDataUrl = "<?= site_url('app/controller/ContactInformationController/saveContactInfoFormData') ?>";
        console.log('Generated URL: ' + saveFormDataUrl); // Check if the URL is correct
    </script>
